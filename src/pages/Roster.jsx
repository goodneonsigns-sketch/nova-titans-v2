  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        ...
        <div className="text-gray-500 text-xs sm:text-sm">{players.length} players</div>
      </div>
      ...
      <div className="mb-6 sm:mb-8">
        <input
          ...
          className="w-full max-w-md px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500"
